        ...
        <v-card class="blue lighten-5">
          ...
          <v-form ref="form" @submit.prevent="submit">
                ...
                <v-row justify="center" align="center">
                  <v-col sm="12" md="12" lg="6" xl="6">
                    <v-menu ref="menu1" v-model="timeMenu1" :close-on-content-click="false" :nudge-right="40"
                      ...
                      <template v-slot:activator="{ on, attrs }">
                        <v-text-field v-model="start" label="Startzeit" prepend-icon="mdi-clock-time-four-outline"
                          readonly v-bind="attrs" v-on="on" :rules="[startRules]"></v-text-field>
                      </template>
                  ...
                  <v-col sm="12" md="12" lg="6" xl="6">
                    <v-menu ref="menu2" v-model="timeMenu2" :close-on-content-click="false" :nudge-right="40"
                      ...
                      min-width="290px">
                      <template v-slot:activator="{ on, attrs }">
                        <v-text-field v-model="end" label="EndZeit" prepend-icon="mdi-clock-time-four-outline" readonly
                          v-bind="attrs" v-on="on" :rules="[endRules]"></v-text-field>
                      </template>
            ...
            <v-card-actions class="justify-end">
              <v-btn class="abbrechen-buttons" rounded outlined text @click="dialog.value = false">Schließen</v-btn>
              <v-btn class="erstellen-buttons" rounded outlined text :disabled="!formIsValid" @click="create">Erstellen
              </v-btn>
            </v-card-actions>
          </v-form>
        </v-card>
