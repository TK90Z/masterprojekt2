    ...
    <v-main>
      <v-container fluid fill-height v-if="hasAccount && needsPassword">
        <v-layout align-center justify-center>
          <v-flex xs12 sm8 md4>
            <v-card class="elevation-12 light-blue lighten-5">
              ...
              <v-card-actions>
                <v-card-text
                  ...
                  @click.stop="hasAccount = false"
                  >Noch kein Konto?
                </v-card-text>
                <v-card-text
                  class="clickable-text"
                  @click.stop="needsPassword = false"
                  >Passwort vergessen?
                </v-card-text>
                <v-spacer></v-spacer>
                <v-btn
        ...
        <v-layout align-center justify-center>
          <v-flex xs12 sm8 md4>
            <v-card class="elevation-12 light-blue lighten-5">
              <v-toolbar dark color="primary">
                <v-toolbar-title
                  >Registrierung Medication-Master</v-toolbar-title
                >
              </v-toolbar>
              <v-card-text>
                <v-form>
              ...
              <v-card-actions>
                <v-card-text
                  class="clickable-text"
                  @click.stop="hasAccount = true"
                  >Ich habe schon ein Konto!</v-card-text
                >
                <v-spacer></v-spacer>
                <v-btn
                  class="login-buttons"
          ...
          <v-flex xs12 sm8 md4>
            <v-card class="elevation-12 light-blue lighten-5">
              ...
              <v-card-text>
                <v-form>
                  <v-text-field
                    v-model="passwortResetForm.email"
                    id="email"
                    prepend-icon="mdi-email"
                    name="email"
                    label="E-Mail"
              ...
              <v-card-actions>
                <v-card-text
                  class="clickable-text"
                  @click.stop="needsPassword = true"
                  >Ich kenne mein Passwort!</v-card-text
                >
                <v-spacer></v-spacer>
                <v-btn
                  class="login-buttons"
